...
import App from '#search/ui/App.tsx';
import { renderWithProviders, simulateSubmitForm } from '#search/ui/shared/test-utils.tsx';
import data from '#shared/__mocks__/scrappedPage.json';
...
jest.mock('#jobs/getGlassDoorUrl/getGlassDoorUrl.ts');
